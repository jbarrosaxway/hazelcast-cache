...
public class RateLimitUtil2 {
    private static final RateLimitUtil2 instance = new RateLimitUtil2();

    private RateLimitUtil2() {}
    
    private HazelcastInstance hazelcastInstance;
    

    public static RateLimitUtil2 getInstance() {
        return instance;
    }
